...
func _unequip_from_slot(slot: EquippableComponent.EquipmentType, add_message: bool):
...
func toggle_equip(equippable_item: Entity, add_message := true) -> void:
...
func restore(save_data: Dictionary) -> void:
	var equipped_indices: Array[int] = save_data["equipped_indices"]
	var inventory := entity.inventory_component
